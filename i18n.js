...
const TRANSLATIONS = {
  ...
  'liar.rules.1':       { fr:'Chacun reçoit 5 cartes réelles. L\'appli choisit un symbole : ♠ ♣ ♦',
                          en:'Everyone gets 5 real cards. The app picks a suit: ♠ ♣ ♦',
                          pt:'Cada um recebe 5 cartas reais. A app escolhe um naipe: ♠ ♣ ♦' },
  'liar.rules.2':       { fr:'À votre tour, posez 1 à 3 cartes face cachée en prétendant que c\'est le bon symbole',
                          en:'On your turn, place 1–3 cards face down claiming they\'re the right suit',
                          pt:'Na sua vez, ponha 1 a 3 cartas viradas dizendo que são do naipe certo' },
  'liar.rules.3':       { fr:'Vous pouvez mentir ! Posez n\'importe quelle carte.',
                          en:'You can lie! Play any card you want.',
                          pt:'Pode mentir! Jogue qualquer carta.' },
  'liar.rules.4':       { fr:'Doutez de quelqu\'un ? Touchez 🚨 LIAR sur son nom',
                          en:'Doubt someone? Tap 🚨 LIAR on their name',
                          pt:'Duvida de alguém? Toque 🚨 LIAR no nome dele' },
  'liar.rules.5':       { fr:'On retourne les cartes. Menteur pris → il tire. Accusation fausse → l\'accusateur tire.',
                          en:'Flip the cards. Caught lying → they shoot. Wrong call → the caller shoots.',
                          pt:'Vire as cartas. Apanhado a mentir → dispara. Acusação errada → o acusador dispara.' },
  'liar.rules.6':       { fr:'🔫 Chacun a SON revolver. CLIC = survie (1 chambre en moins). BANG = éliminé !',
                          en:'🔫 Everyone has THEIR own revolver. CLICK = survive (1 fewer chamber). BANG = out!',
                          pt:'🔫 Cada um tem o SEU revólver. CLIQUE = sobrevive (menos 1 câmara). BANG = eliminado!' },
